...
var restClient = (function (window, undefined) {
    ...
    //获取相应回调集合
    function getAction(callback, codes) {
        var options = {};
        var DEFAULTS = {
        ...
        return getCallback(options, codes);
    }
     ...
     * 1002 java请求失败
     */
    function needGlobalResolve(data, codes) {
...
function userLogin() {
    ...
    return userLogin = {
        ...
        register: function () {
            ...
            restClient.postFormData("/users/register", {
                mobile: phoneNum,
                password: password,
                code: authCode,
                qq_number: QQ
        ...
        getCheckCode: function () {
            ...
            restClient.postFormData('/users/send_message', {
                'mobile': phoneNum,
                'operate_type': type,
                'rand_code': checkCode
            }, action);
        ...
        wechatWord: '<div id="wechatWord" class="modal">' +
        ...
        '            </div>' +
        '        </div>',
        bindStore: '<div id="bindStore" class="modal">' +
        '<div class="modal-dialog user-login user-login-l" >' +
        ...
        findPassword: '<div id="findPassword" class="modal">' +
        ...
        login: '<div id="login" class="modal">' +
        '<div class="modal-dialog user-login " >' +
        '<form name="login" >' +
        ...
        signIn: '<div id="signIn" class="modal">' +
        '<div class="modal-dialog user-login " >' +
        ...
        '    </div>' +
        '    </div>',
        invite: '<div id="invite" class="modal">' +
        ...
        '    </div>' +
        '</div>',
        bindMobile: '<div id="bindMobile" class="modal">' +
        '    <div class="modal-dialog user-login" >' +
